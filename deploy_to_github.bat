...
if exist "%~dp0\PhotoMat2026.pdf" (
    copy "%~dp0\PhotoMat2026.pdf" "%~dp0\photonics-workshop-website\public\brochure\PhotoMat2026.pdf" /Y >nul
    echo   + Brochure PDF copied successfully.
) else (
    echo   [WARNING] PhotoMat2026.pdf not found in root.
)
